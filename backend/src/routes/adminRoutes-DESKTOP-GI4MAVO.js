...
router.post('/products', upload.array('images', 6), upload.validateUploadedImages, adminProductController.create);
router.put('/products/:id', upload.array('images', 6), upload.validateUploadedImages, adminProductController.update);
